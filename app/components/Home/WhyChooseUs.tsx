    ...
    <section className="relative py-20 bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-4 md:px-2">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {/* Second row - Features 3 and 4 with 7:3 ratio */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            {/* Feature 3 - Takes 7 columns */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
              className={`relative p-10 rounded-3xl shadow-xl transition-all duration-500 ease-in-out min-h-[400px] flex flex-col lg:col-span-7 ${hoveredIndex === 2
                ? `${features[2].hoverBgColor} ${features[2].hoverTextColor} shadow-2xl scale-105`
                : `${features[2].bgColor} ${features[2].textColor}`
                }`}
            ...
            >
              ...
              <div className="flex-1 flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1 md:w-1/2">
                  ...
                  <motion.p
                    ...
                    transition={{ duration: 0.3 }}
                    className="text-lg leading-relaxed transition-colors duration-500 mb-6 md:mb-0"
                  >
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#014330] to-[#017755] -z-10"
              />
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className={`relative p-10 rounded-3xl shadow-xl transition-all duration-500 ease-in-out min-h-[400px] flex flex-col lg:col-span-5 ${hoveredIndex === 3
                ? `${features[3].hoverBgColor} ${features[3].hoverTextColor} shadow-2xl scale-105`
                : `${features[3].bgColor} ${features[3].textColor}`
                }`}
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                className="absolute inset-0 rounded-3xl bg-[#A57000] -z-10"
              />
            </motion.div>
          </div>
        </div>
